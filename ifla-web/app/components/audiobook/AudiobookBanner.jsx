...
export const AudiobookBanner = ({audiobook}) => {
  ...
  return (
    <Layout as={'article'} intent={'banner'} className={'bg-audiobook'}>
      <Layout
        intent={'grid'}
        as={'div'}
      ...
      >
        ...
        <div className={clsx('h-min col-span-1 columns-1 gap-8')}>
          <div className={'aspect-square'}>
            {/* <iframe
              ...
              frameborder="no"
              allow="autoplay"
              src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1033139458&color=%23ded3c5&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=true"
            ></iframe> */}
            <iframe
              width="100%"
              height="100%"
